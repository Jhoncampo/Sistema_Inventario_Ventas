...
namespace Sistema_Inventario_Ventas.Vistas
{
    public partial class FormUsuarios : Form
    {
        ...
        private void FormatoTablaUsuarios(DataTable datos)
        {
            try
            {
                ...
                datos.Columns["contrasena"].ColumnName = "CONTRASENA";
                ...
                DGVUsuarios.Columns["CONTRASENA"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private void DGVUsuarios_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                tbActContrasena.Text = DGVUsuarios.Rows[e.RowIndex].Cells["CONTRASENA"].Value.ToString().Trim();
